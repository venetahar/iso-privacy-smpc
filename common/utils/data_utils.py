...
class DataUtils:
    ...
    def save_indices(train_indices, test_indices, data_path):
        ...
        """
        savetxt(data_path + 'train_indices.csv', train_indices, delimiter=',', fmt='%i')
        savetxt(data_path + 'test_indices.csv', test_indices, delimiter=',', fmt='%i')
    ...
    def load_indices(data_path):
        ...
        """
        train_indices = loadtxt(data_path + 'train_indices.csv', delimiter=',')
        test_indices = loadtxt(data_path + 'test_indices.csv', delimiter=',')
