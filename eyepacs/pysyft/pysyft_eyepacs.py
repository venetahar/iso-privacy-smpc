...
from eyepacs.common.constants import TEST_BATCH_SIZE, TEST_CSV_PATH
from eyepacs.pysyft.private_eyepacs_data_loader import PrivateEyepacsDataLoader
...
class PysyftEyepacs:
    ...
    def encrypt_evaluate_model(self, model):
    ...
    def encrypt_data(self):
        # TODO: Add proper training path
        self.data_loader = PrivateEyepacsDataLoader(self.alice, self.bob, self.crypto_provider,
