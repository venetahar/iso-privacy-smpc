...
from eyepacs.common.constants import ALICE, BOB, EYEPACS_CHANNELS, EYEPACS_WIDTH, EYEPACS_HEIGHT


class CryptenEyepacs:
    ...
    def encrypt_evaluate_model(self, path_to_model, path_to_data, path_to_labels, dummy_model):
        encrypt_model_metric = TimeMetric("encrypt_model")
        start_time = time.time()
        self.encrypt_model(path_to_model, dummy_model)
    ...
    def encrypt_model(self, path_to_model, dummy_model):
        dummy_input = torch.empty((1, EYEPACS_CHANNELS, EYEPACS_WIDTH, EYEPACS_HEIGHT))
